    ...
    def print_args(self, id, object):
        if id == constants.MAP_CODE:
            ...
            if newX != -1 and newY != -1:
                ...
                print("\033[20;1H", end = "", flush=True)
                print(str(points) + " *", end = "", flush = True)

        elif id == constants.GHOST_CODE:
            direc, num, pos, x, y , points_map= object
            x = x + 2
            y = y + 1
            newX = pos[0]+ 2
            newY = pos[1] + 1
            ...
            print("\033["+ str(newX) + ";" + str(newY) + "H", end = "", flush=True)
            print(constants.GHOST, end = "", flush = True)
        elif id == "ENDGAME":
            win, point = object
